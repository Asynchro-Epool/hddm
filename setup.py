...
setup(
    ...
    install_requires=['numpy >=1.20.0', 'scipy >= 1.6.3', 'cython >= 0.29.0, < 1.0.0', 'pandas', 'patsy', 'seaborn', 'statsmodels >= 0.12.0', 'tqdm >= 4.1.0', 'scikit-learn', 'cloudpickle >= 2.0.0', 'kabuki >= 0.6.0', 'PyMC >= 2.3.3, < 3.0.0', 'arviz', 'ssm-simulators'],
    setup_requires=['numpy >=1.20.0', 'scipy >= 1.6.3', 'cython >= 0.29.0, < 1.0.0', 'pandas' 'patsy', 'seaborn', 'statsmodels >= 0.12.0', 'tqdm >= 4.1.0', 'scikit-learn', 'cloudpickle >= 2.0.0', 'kabuki >= 0.6.0', 'PyMC >= 2.3.3, < 3.0.0', 'arviz', 'ssm-simulators'],
